...
internal enum Asset {
  ...
  internal static let subtleText = ColorAsset(name: "SubtleText")
  ...
  internal static let iconBook = ImageAsset(name: "icon_book")
  internal static let iconCalender = ImageAsset(name: "icon_calender")
  internal static let iconCheck = ImageAsset(name: "icon_check")
  internal static let iconCoffee = ImageAsset(name: "icon_coffee")
  internal static let iconGenderMan = ImageAsset(name: "icon_gender_man")
  internal static let iconGenderWoman = ImageAsset(name: "icon_gender_woman")
  internal static let iconGoogle = ImageAsset(name: "icon_google")
  internal static let iconHeart = ImageAsset(name: "icon_heart")
  internal static let iconHeartRed = ImageAsset(name: "icon_heart_red")
  internal static let iconHomeWifi = ImageAsset(name: "icon_home_wifi")
  ...
  internal static let iconStarFilled = ImageAsset(name: "icon_star_filled")
  internal static let iconUser = ImageAsset(name: "icon_user")
  internal static let bottomFadeImage = ImageAsset(name: "bottom-fade-image")
  internal static let imageEmptyNotifications = ImageAsset(name: "image_empty_notifications")
  internal static let loginHeader = ImageAsset(name: "login-header")
